...
export default function FashionStorePage() {
  ...
  const allProducts = [
    { id: 1, name: "Classic White Tee", price: 25, image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBzVMML6zIoItR7cOE1ikgGaW5LdbBrOLkojEWEBWtHIg0FjOMvOOZAScOUDJBWaBtrN8mW2DlASHMvgCUQj2yB22EH0MiJye26KrUYhB038B762NMeCdTWmmeX4jiy2sZQ370xnAZo4d9tGn3XOv6TiSS2Pi94i4F3WShVPCA6BTBKqjh8VhH9Qsxt3BcGzCMVhZ12KfgjdRSjlGEVd3nH6fI0pwPnhHJf7-Z177E3h0PX1gwcTMvIY3PV_SgeA9ZtNQ9hLfbcAg4", category: "Shirts", material: "Cotton", color: "white" },
    { id: 2, name: "Slim Fit Jeans", price: 60, image: "https://lh3.googleusercontent.com/aida-public/AB6AXuDcfZOc8GkbxKy99w-Sd2_iTMaHKfDX_gb6AOuPRfrFnrjTvbpJCI1mDpkhpxXeLAiTVY90RKOt2R_EIUizN5zHjIrO8IwDYXKPsXw20xczFYMAvnxAs3eKrsRDocngWe1BPEMqbuEa66-3STzVjdPbiK68KZMkG-WgPgD57Sci8U_sgVGOUl0IdSkxGIBD40VTqaTUMDjvfu_KSQBKGFlnV9gdsw6TQtJhl8l3DlDIW14w6H59cviWoPKv909UvFjeVfFzE_Gkp5Q", category: "Pants", material: "Denim", color: "blue" },
    { id: 3, name: "Summer Dress", price: 45, image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCjA8t-m5iklCop35UR-3jcrO7ENL8MUCz0oTeo2eKnwnZK1yFjTpjLwySIIsFxu6o2CacY_1yqT9ZxESuxhQUy3F8LSJZdyWIdwZp2Xew8mvZziJ8GyTSt9O3xuHNcYJ9Fq5AQp2NuvT6x6ECFZs8xEYTcyIUcrnV0919v0eAN4f978WTQwQuQ0TJCCa5__zsIY_PoZIsavaUkOeQk8Go2f8vrrTbIx2OXUJ1Yt17q9dQFby5hvGRL55z9LCrWM-o73928tX4uWXs", category: "Dresses", material: "Cotton", color: "yellow" },
    { id: 4, name: "Kids' Graphic Tee", price: 20, image: "https://lh3.googleusercontent.com/aida-public/AB6AXuA6FOTrj8lcdKQ_uktwTDDdUUQ-CfB_paWq-Ic1dvWuZilS-3IVFKTMkV6H7mzdLhIK7k-LKdhGFdMUlhYjfaSz_CQiInCmLJkFEk2mAh3vFKkkq0MJaOdBKwLMLVhclUKMiobgeeqpNzekEp8yiLHhGHuQP5gcrc8Zwkl49IkJIimXaaqvymRlJxOzNmMm7lQ86_rGGAR0b50FALSHDJsvfdulg1IpsmhcFt7Wc7t6POeoYaKiHMQBf0USo6CASGAM-sqLyRXoam8", category: "Shirts", material: "Cotton", color: "blue" },
    { id: 5, name: "Men's Casual Shirt", price: 55, image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAxI3XrA7nonDJ1P4oaR4kv2y0CE-fXoXiYFjTv47Tsvzc6rf3HpfyZAOAX96XqVZ8bMreqAfA1Tli5I1xlyF6YvpClWcyuPQouYt4Mv_5N51R6AkqzhVh13ZAptwT8h0b3ibNOWjzOAXLZRcw1wrs7ch7mOedHlfDa6FWyVfVwXgdsSBQMmc6vq8uQui35o4Q_C_I4yGemEECjGLsf6cHN5VCVhQDNY7zh-hiJLC_CDiXeKLOh5C153ShkrzwZt4KpSdmcVsxVVJ4", category: "Shirts", material: "Cotton", color: "white" },
    { id: 6, name: "Women's Blouse", price: 40, image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAXjlqV_9PVEiy3kN8OXUPPkI3exrO0ZDUnZkw_mvgDLpf5m06NHdPn0-X_fGwf2xmwSpo3WKfACpdGLdmmCmLVyz4IUD0hmyMsZeAIEAkBferwK2iJDaTWJPgsc72xBPfKc79VYpOjmJk4b_O6aFbmja8j6dobyoTrs4mNjDKPmOU0658Glb6M9Xw6wifG54ho2rS5vqTl8meOhxI4bC-OwKcVL4oPc8lscM5HxlWBbJwObY_ld5oT8SVf6aIijgJCNM1XXTwO-2w", category: "Shirts", material: "Silk", color: "white" },
    { id: 7, name: "Kids' Denim Shorts", price: 18, image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAwkSTuAL4L56hfCNDA4aliO5nAuYDLrKMwyVJ-2VdYYLLTejL4_99rOJPjDkvdxD_A3hsNXT2uU8anRKSnKBBu4Q9XQhvmsPptBn_jUIQ6lGYDI1zmzvAPYVPN5bST9LVzUqJP2IGT95z3xDksWwTfwMRFLPYQABvFzbdxLK2gqGObi060H6G0sVS3jIKmDQlXXcx57fUKvuGlL_HwEvCMYfz68ysXYujAxAER71zfUjxAt41bp6twN-yq1CO1JpjM0XeFpf2DTJ4", category: "Pants", material: "Denim", color: "blue" },
    { id: 8, name: "Men's Chinos", price: 50, image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBoYl4r5SAdMU7d0obSxm6RpDe_nDOrwImpVKPEUbY57Sj-lZLZvk0E7OsmWmFtBt25WEgVSMzKuxNfUIs91KPty48p1nfzuY5cGJ7qLWnPM7ZNRszIeDmtF4XFgl4-1T_uoODL6JJpxPZtxPe8k_PFOTmMqCxnujg7gforbhr60UgpsrPs4Vri1CtJPFqIxsrQSv26VVImV23dEGshxV6kOnXXcw5xEOK02-uOGlfYwSi2tuRWC4ipA4WQ1PZRNiYef4aAXQ4xnHY", category: "Pants", material: "Cotton", color: "black" },
    { id: 9, name: "Wool Sweater", price: 75, image: "https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=300&h=400&fit=crop", category: "Outerwear", material: "Wool", color: "red" },
    { id: 10, name: "Black Jeans", price: 65, image: "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=300&h=400&fit=crop", category: "Pants", material: "Denim", color: "black" },
    { id: 11, name: "Green T-Shirt", price: 30, image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=300&h=400&fit=crop", category: "Shirts", material: "Cotton", color: "green" },
    { id: 12, name: "Floral Dress", price: 85, image: "https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=300&h=400&fit=crop", category: "Dresses", material: "Silk", color: "red" },
    { id: 13, name: "Denim Jacket", price: 90, image: "https://images.unsplash.com/photo-1551028719-00167b16eac5?w=300&h=400&fit=crop", category: "Outerwear", material: "Denim", color: "blue" },
    { id: 14, name: "White Blouse", price: 42, image: "https://images.unsplash.com/photo-1594633313593-bab3825d0caf?w=300&h=400&fit=crop", category: "Shirts", material: "Cotton", color: "white" },
    { id: 15, name: "Red Hoodie", price: 48, image: "https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=300&h=400&fit=crop", category: "Outerwear", material: "Cotton", color: "red" },
    { id: 16, name: "Silk Scarf", price: 35, image: "https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?w=300&h=400&fit=crop", category: "Outerwear", material: "Silk", color: "blue" }
  ];
        ...
        filteredAndSortedProducts.map(product => (
          <div key={product.id} className="flex flex-col gap-3 group cursor-pointer">
            <div className="relative overflow-hidden">
              ...
              <button className="absolute top-3 right-3 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:bg-gray-100">
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-1">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-xs text-[#637588]">(4.5)</span>
                </div>
              </div>
